        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center">
                <a href="index.php" class="flex items-center">
                    <i class="fas fa-graduation-cap text-purple-300 text-2xl mr-2"></i>
                    <span class="text-xl font-bold text-purple-100">Kafe</span>
                </a>
            </div>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="max-w-md mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6">
                <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">Вход в аккаунт</h1>
                ...
                <form method="POST" class="space-y-4" id="loginForm">
                    ...
                    <button type="submit" class="w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition">
                        Войти
                    </button>
                </form>
