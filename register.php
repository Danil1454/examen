        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center">
                <a href="index.php" class="flex items-center">
                    ...
                    <span class="text-xl font-bold text-gray-800">Kafe</span>
                </a>
            </div>
            
            <div class="hidden md:flex items-center space-x-6">
                <a href="colleges.php" class="text-gray-700 hover:text-blue-600 transition">Заказы
                </a>
        ...
        <div class="max-w-md mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="college" class="block text-sm font-medium text-gray-700 mb-1">Название Положения</label>
