...
<body class="bg-gray-50 font-sans">
    ...
    <!-- Header -->
    <header class="bg-green shadow-sm"><main class="container mx-auto px-4 py-8 max-w-5xl">

        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center">
                <a href="index.php" class="flex items-center">
                    <span class="text-xl font-bold text-green-800">Kafe</span>
                </a>
            </div>
            
            <div class="hidden md:flex items-center space-x-6">
                <a href="colleges.php" class="text-black-700 hover:text-pink-600 transition">Администраторы</a>
                <a href="menyou.php" class="text-black-700 hover:text-pink-600 transition">Меню</a>
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php else: ?>
                <a href="login.php" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-pink-700 transition">
                    Войти
                </a>
                <?php endif; ?>
            </div>
    ...
    <!-- Hero Section -->
    <section class="bg-green-600 text-black py-14">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">ИС управления заведениями общественного питания типа – кафе </h1>
                <p class="text-xl text-white mb-8">
                Заказ лучшего кофе только у нас!
</p>

                <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="colleges.php" style="background-color: green; color: white; padding: 12px 24px; border-radius: 10px; font-size: 16px; transition: background-color 0.3s ease;">
  Заказать кофе
</a>
...
<section class="bg-black py-8">
  <div class="container mx-auto px-4">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="bg-green-200 p-3 rounded-lg shadow-md text-center">
        <div class="text-xl font-bold text-green-800 mb-1">150</div>
        <p class="text-green-600 text-sm">Заказы</p>
      </div>
      
      <div class="bg-green-200 p-3 rounded-lg shadow-md text-center">
        <div class="text-xl font-bold text-green-800 mb-1">5</div>
        <p class="text-green-600 text-sm">Повара</p>
      </div>
      
      <div class="bg-green-200 p-3 rounded-lg shadow-md text-center">
        <div class="text-xl font-bold text-green-800 mb-1">12</div>
        <p class="text-green-600 text-sm">Официант</p>
      </div>
