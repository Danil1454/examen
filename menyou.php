...
<main class="container mx-auto px-4 py-8">
  ...
  <div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-4">
      <h1 class="text-2xl font-bold text-green-800">Заказы для повара</h1>
      <button class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 flex items-center" onclick="showCreateOrderForm()">
    ...
    <div class="mb-4 flex items-center space-x-4">
      <label class="flex items-center space-x-2">
        <input type="radio" name="order_filter" value="all" checked class="form-radio text-green-600" onchange="filterOrders()" />
        <span>Все заказы</span>
      </label>
      <label class="flex items-center space-x-2">
        <input type="radio" name="order_filter" value="current" class="form-radio text-green-600" onchange="filterOrders()" />
    ...
    <div class="overflow-x-auto">
      <table class="min-w-full bg-white rounded-lg shadow-md border border-green-300" id="ordersTable">
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr data-shift="current" data-order="201">
            ...
            <td class="py-2 px-4 border-b border-green-300">
              <button class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600" onclick="changeOrderStatus(201, 'готов')">Пометить как готов</button>
            </td>
          </tr>
          <tr data-shift="current" data-order="202">
            <td class="py-2 px-4 border-b border-green-300">202</td>
            <td class="py-2 px-4 border-b border-green-300">Максим</td>
            <td class="py-2 px-4 border-b border-green-300">
              <span class="bg-green-200 text-green-800 px-2 py-1 rounded-full text-sm">Готов</span>
            </td>
            <td class="py-2 px-4 border-b border-green-300">
              <button class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600" onclick="changeOrderStatus(202, 'не готов')">Пометить как не готов</button>
            </td>
          </tr>
